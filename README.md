...
When looking at logs in the Row format, the coloured bar indicates the percentage makeup of the log's average w.r.t to the current entries entries sum of averages. When an entry is over 75% of the category it will be coloured red, when less than 75% but higher than 25%, it will be blue. If it is less than 25% or is precisely 100% of the entry, it will be shown as grey.
