    ...
    internal static class H_PawnTickProfile
    {
        ...
        public static IEnumerable<MethodInfo> GetPatchMethods()
        {
            ...
            yield return AccessTools.Method(typeof(Pawn_ApparelTracker),
                nameof(Pawn_ApparelTracker.ApparelTrackerTick));
            ...
            yield return AccessTools.Method(typeof(Pawn_RoyaltyTracker),
                nameof(Pawn_RoyaltyTracker.RoyaltyTrackerTick));
            yield return AccessTools.Method(typeof(Pawn_CallTracker), nameof(Pawn_CallTracker.CallTrackerTick));
            yield return AccessTools.Method(typeof(Pawn_RelationsTracker),
                nameof(Pawn_RelationsTracker.RelationsTrackerTick));
            yield return AccessTools.Method(typeof(Pawn_PsychicEntropyTracker),
                nameof(Pawn_PsychicEntropyTracker.PsychicEntropyTrackerTick));
            yield return AccessTools.Method(typeof(Pawn_InteractionsTracker),
                nameof(Pawn_InteractionsTracker.InteractionsTrackerTick));
#else
            yield return AccessTools.Method(typeof(Pawn_AgeTracker), nameof(Pawn_AgeTracker.AgeTickInterval));
            yield return AccessTools.Method(typeof(Pawn_RecordsTracker),
                nameof(Pawn_RecordsTracker.RecordsTickInterval));
            yield return AccessTools.Method(typeof(Pawn_CarryTracker),
                nameof(Pawn_CarryTracker.CarryHandsTickInterval));
            yield return AccessTools.Method(typeof(Pawn_NeedsTracker),
                nameof(Pawn_NeedsTracker.NeedsTrackerTickInterval));
            yield return AccessTools.Method(typeof(Pawn_MindState), nameof(Pawn_MindState.MindStateTickInterval));
            yield return AccessTools.Method(typeof(Pawn_ApparelTracker),
                nameof(Pawn_ApparelTracker.ApparelTrackerTickInterval));
            yield return AccessTools.Method(typeof(Pawn_SkillTracker), nameof(Pawn_SkillTracker.SkillsTickInterval));
            yield return AccessTools.Method(typeof(Pawn_GuestTracker),
                nameof(Pawn_GuestTracker.GuestTrackerTickInterval));
            yield return AccessTools.Method(typeof(Pawn_RoyaltyTracker),
                nameof(Pawn_RoyaltyTracker.RoyaltyTrackerTickInterval));
            yield return AccessTools.Method(typeof(Pawn_CallTracker), nameof(Pawn_CallTracker.CallTrackerTickInterval));
            yield return AccessTools.Method(typeof(Pawn_RelationsTracker),
                nameof(Pawn_RelationsTracker.RelationsTrackerTickInterval));
            yield return AccessTools.Method(typeof(Pawn_PsychicEntropyTracker),
                nameof(Pawn_PsychicEntropyTracker.PsychicEntropyTrackerTickInterval));
            yield return AccessTools.Method(typeof(Pawn_InteractionsTracker),
                nameof(Pawn_InteractionsTracker.InteractionsTrackerTickInterval));
#endif
        }
    }
}